                        ...
                        <Card className="shadow-lg">
                            <CardHeader className="space-y-1">
                                ...
                                <CardDescription className="text-center">
                                    Utilize seu e-mail e senha ou continue com Google
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                {needsConfirmation && (
                                    <div className="p-4 bg-yellow-100 border border-yellow-400 text-yellow-700 rounded">
                                        <p className="font-medium">Confirmação de e-mail necessária!</p>
                                        <p className="mt-1 text-sm">
                                            Verifique sua caixa de entrada pelo e-mail de confirmação.
                                        </p>
                                        <Button
                                            variant="link"
                                            className="mt-2 text-[#9b87f5] hover:text-[#7E69AB] p-0 h-auto"
                                ...
                                >
                                    ...
                                    {socialLoading ? 'Carregando...' : 'Continuar com Google'}
                                </Button>
